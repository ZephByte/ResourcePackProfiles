...
## Resource Pack Profiles - v1.0.0+26.1

> **First stable release.** Please report any issues on [GitHub](https://github.com/ZephByte/ResourcePackProfiles/issues).
>
> Covers all **26.1.x** versions of Minecraft.

First stable release of **Resource Pack Profiles**, a lightweight client-side Fabric mod that adds named load-order profiles to the resource pack screen.
...
## Resource Pack Profiles - v1.0.0-beta.1+26.1
